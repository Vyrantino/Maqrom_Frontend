...
export default function Homepage() {
  ...
  return (
    <Box>
      ...
      <hr />
      <Container>
        <Grid container spacing={0.5} sx={{}} justifyContent={"space-around"}>
          {cards.map((item) => (
            <Carta
              key={item.idCard}
              img={item.img}
      ...
      >
        ...
        <img src={MaqromLogo} width={200} height={200} />
        ...
        <Box>
          ...
          <Typography color="info.main" sx={{ m: 3 }}>
            Estamos a sus ordenes!
          </Typography>
        </Box>
        <Box>
          <Typography variant="h4" color="info.main" sx={{ m: 3 }}>
            Nuestro trabajo
          </Typography>

          <Typography color="info.main" sx={{ m: 10 }}>
